...
// Direct imports using relative paths for tsx
const { calculatePlanets, calculateAscendant, SIGNS, NAKSHATRAS, calculateVimshottariDasha } = require('./src/services/calculations/astronomy');
...
console.log('  Moon Sign (Rashi): Capricorn (Makar)');
console.log('  Nakshatra: Shravana');
console.log('  Manglik: NOT Manglik');
console.log('='.repeat(60));
