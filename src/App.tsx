...
import { Sparkles, Calendar, Sun, Star, BookOpen, Hash } from 'lucide-react'

type TabType = 'vedic' | 'lalkitab' | 'numerology' | 'western' | 'tarot' | 'panchang'
            ...
            <div className="min-h-screen bg-bg-primary">
                ...
                <footer className="bg-bg-secondary border-t border-border-primary mt-16">
                    <div className="container mx-auto px-4 py-6 text-center text-text-tertiary text-sm">
                        Session 4 Complete: Numerology (Life Path, Destiny, Soul Urge) • Next: Combined Analysis
                    </div>
                </footer>
            </div>
        </AstrologyProvider>
